...
<head>
    ...
    <title>Manage Coupons | LuvShop Admin</title>
    ...
    <main class="ml-64 min-h-screen" id="app-main">
        ...
        <section class="p-6 md:p-8">
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-3">
                <h1 class="text-2xl font-semibold text-slate-900">Coupons</h1>
                <p class="text-slate-500">Create and control coupon campaigns.</p>
