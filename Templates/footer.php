...
<footer class="site-footer w-full bg-tertiary-container dark:bg-tertiary px-6 py-12 md:px-10 md:py-14 text-left">
        ...
        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.45fr_1fr_1.05fr_1fr_1.25fr] lg:gap-12">
            ...
            <nav aria-label="Information" class="space-y-4">
                ...
                <div class="flex flex-col gap-3">
                    <a class="text-sm font-body-md text-on-tertiary-container/75 transition-colors hover:text-primary dark:text-on-tertiary/75 dark:hover:text-primary-fixed-dim" href="<?= $navPrefix ?>aboutUs.php">About Us</a>
                    <a class="text-sm font-body-md text-on-tertiary-container/75 transition-colors hover:text-primary dark:text-on-tertiary/75 dark:hover:text-primary-fixed-dim" href="<?= $navPrefix ?>shop.php">More Search</a>
            ...
            <nav aria-label="Helpful links" class="space-y-4">
                ...
                <div class="flex flex-col gap-3">
                    <a class="text-sm font-body-md text-on-tertiary-container/75 transition-colors hover:text-primary dark:text-on-tertiary/75 dark:hover:text-primary-fixed-dim" href="<?= $navPrefix ?>contactUs.php">Services</a>
                    <a class="text-sm font-body-md text-on-tertiary-container/75 transition-colors hover:text-primary dark:text-on-tertiary/75 dark:hover:text-primary-fixed-dim" href="<?= $navPrefix ?>contactUs.php">Supports</a>
            ...
            <nav aria-label="Our services" class="space-y-4">
                ...
                <div class="flex flex-col gap-3">
                    <a class="text-sm font-body-md text-on-tertiary-container/75 transition-colors hover:text-primary dark:text-on-tertiary/75 dark:hover:text-primary-fixed-dim" href="<?= $navPrefix ?>shop.php">Brands list</a>
                    <a class="text-sm font-body-md text-on-tertiary-container/75 transition-colors hover:text-primary dark:text-on-tertiary/75 dark:hover:text-primary-fixed-dim" href="<?= $navPrefix ?>checkout.php">Order</a>
                    <a class="text-sm font-body-md text-on-tertiary-container/75 transition-colors hover:text-primary dark:text-on-tertiary/75 dark:hover:text-primary-fixed-dim" href="<?= $navPrefix ?>contactUs.php">Return &amp; Exchange</a>
                    <a class="text-sm font-body-md text-on-tertiary-container/75 transition-colors hover:text-primary dark:text-on-tertiary/75 dark:hover:text-primary-fixed-dim" href="<?= $navPrefix ?>shop.php">Fashion list</a>
                    <a class="text-sm font-body-md text-on-tertiary-container/75 transition-colors hover:text-primary dark:text-on-tertiary/75 dark:hover:text-primary-fixed-dim" href="<?= $navPrefix ?>Home.php">Blog</a>
                </div>
            </nav>
