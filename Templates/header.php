...
<header class="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-gutter h-16 bg-surface dark:bg-surface shadow-sm opacity-90">
    ...
    <nav class="hidden md:flex items-center gap-xl">
        <a class="<?= ($activePage === 'home' ? $activeLinkClass : $inactiveLinkClass) . ' ' . $baseLinkClass ?>" href="Home.php">Home</a>
        <a class="<?= ($activePage === 'shop' ? $activeLinkClass : $inactiveLinkClass) . ' ' . $baseLinkClass ?>" href="shop.php">Shop</a>
        <a class="<?= ($activePage === 'contact' ? $activeLinkClass : $inactiveLinkClass) . ' ' . $baseLinkClass ?>" href="contactUs.php">Contact</a>
        <a class="<?= $inactiveLinkClass . ' ' . $baseLinkClass ?>" href="#">Login</a>
